...
if __name__ == "__main__":
    #annotation_file = os.path.join(ANNOTATION_DIR, "combined_annotations_about_40k_png_only.csv")
    ...
    #for model_type in ['efficientnetb0']:
        ...
        metrics_file = os.path.join(MODEL_DIR,f'coral_reef_classifier_{model_type}_epoch_{epoch}_1_batchsize_{batch_size}_metrics.json')
